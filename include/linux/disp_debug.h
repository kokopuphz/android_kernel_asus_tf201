...
#else
#define DISP_EMERG(fmt, args...)
#define DISP_ALERT(fmt, args...)
#define DISP_CRIT(fmt, args...)
#define DISP_ERR(fmt, args...)		printk(KERN_ERR "[DISP]"fmt, ##args);
#define DISP_WARN(fmt, args...)
#define DISP_NOTICE(fmt, args...)
#define DISP_INFO(fmt, args...)
#define DISP_CONT(fmt, args...)
#define DISP_DEBUG(fmt, args...)
