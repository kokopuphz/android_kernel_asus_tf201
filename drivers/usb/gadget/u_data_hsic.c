...
#include <linux/termios.h>
#include <../arch/arm/mach-tegra/eprj_enru/include/mach/usb_bridge.h>
#include <../arch/arm/mach-tegra/eprj_enru/include/mach/usb_gadget_xport.h>
...
static void ghsic_data_write_tohost(struct work_struct *w)
{
	...
	while (!list_empty(&port->tx_idle)) {
        ...
        /*	If the data amount is a multple of the
         *	maxpacket size then send a zero length packet.
         */
		req->zero = ((req->length % ep->maxpacket) == 0);
