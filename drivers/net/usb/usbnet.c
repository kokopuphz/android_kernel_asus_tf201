...
#include <linux/pm_qos.h> //EPRJ-HTC
...
#define PM_QOS_USBNET_CPU_FREQ_MIN_VALUE 102000 /* Original was 412MHz */
#define PM_QOS_USBNET_MIN_ONLINE_CPUS 2

#ifdef CONFIG_PERFLOCK
static struct perf_lock usbnet_perf_lock;
#endif
static struct pm_qos_request usbnet_req_freq;
static struct pm_qos_request usbnet_req_cpus;
