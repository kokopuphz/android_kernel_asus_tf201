...
#define DP3T_IN_1_GPIO	TEGRA_GPIO_PCC2	
#define USIF_IN_1_GPIO	TEGRA_GPIO_PY3	/* USIF1_SW */
#define IFX_USB_VBUS_EN_GPIO TEGRA_GPIO_PR4	/* IFX_USB_VBUS_EN */
...
#include "../../video/tegra/sii9244/sii9244_driver.h"
#endif//
