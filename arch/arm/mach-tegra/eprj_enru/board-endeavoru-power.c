...
static struct tps80031_rtc_platform_data rtc_data = {
	...
	.msecure_gpio = PMU_GPIO_PMU_MSECURE,
};
...
// DEVICE-TREE MACHINE IS NOT ENDEAVORU, BUT DT!!
...
//	endeavoru_gpio_rtc_init();
	...
	i2c_register_board_info(4, endeavoru_regulators, 1);
...
#endif
/* EternityProject, 22/09/2012: Remove CPU resume frequency boosting
...
static struct platform_device eprj_enru_bpc_mgmt_device = {
	.name		= "tegra-bpc-mgmt",
	.id		= -1,
	.dev		= {
...
void __init eprj_enru_bpc_mgmt_init(void)
{
#ifdef CONFIG_SMP
...
#endif
	platform_device_register(&eprj_enru_bpc_mgmt_device);
