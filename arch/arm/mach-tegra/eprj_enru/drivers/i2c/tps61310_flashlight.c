...
#include "../include/tps61310_flashlight.h"
#include "../../include/mach/mfootprint.h"
...
int tps61310_flashlight_control(int mode)
{
	...
	break;
	case FL_MODE_FLASH_LEVEL1:	//150mA
		tps61310_i2c_command(0x05, 0x6A);
		tps61310_i2c_command(0x00, 0x00);
		...
		queue_delayed_work(tps61310_work_queue, &tps61310_delayed_work,
			msecs_to_jiffies(this_tps61310->flash_sw_timeout));
	break;
	case FL_MODE_FLASH_LEVEL2:	//200mA
		tps61310_i2c_command(0x05, 0x6A);
		tps61310_i2c_command(0x00, 0x00);
		...
		queue_delayed_work(tps61310_work_queue, &tps61310_delayed_work,
			msecs_to_jiffies(this_tps61310->flash_sw_timeout));
	break;
	case FL_MODE_FLASH_LEVEL3:	//300mA
		tps61310_i2c_command(0x05, 0x6A);
		tps61310_i2c_command(0x00, 0x00);
		...
		queue_delayed_work(tps61310_work_queue, &tps61310_delayed_work,
			msecs_to_jiffies(this_tps61310->flash_sw_timeout));
	break;
	case FL_MODE_FLASH_LEVEL4:	//400mA
		tps61310_i2c_command(0x05, 0x6A);
		tps61310_i2c_command(0x00, 0x00);
		...
		queue_delayed_work(tps61310_work_queue, &tps61310_delayed_work,
			msecs_to_jiffies(this_tps61310->flash_sw_timeout));
	break;
	case FL_MODE_FLASH_LEVEL5:	//500mA
		tps61310_i2c_command(0x05, 0x6A);
		tps61310_i2c_command(0x00, 0x00);
		...
		queue_delayed_work(tps61310_work_queue, &tps61310_delayed_work,
			msecs_to_jiffies(this_tps61310->flash_sw_timeout));
	break;
	case FL_MODE_FLASH_LEVEL6:	//600mA
		tps61310_i2c_command(0x05, 0x6A);
		tps61310_i2c_command(0x00, 0x00);
		...
		queue_delayed_work(tps61310_work_queue, &tps61310_delayed_work,
			msecs_to_jiffies(this_tps61310->flash_sw_timeout));
	break;
	case FL_MODE_FLASH_LEVEL7: //700mA
		tps61310_i2c_command(0x05, 0x6A);
		tps61310_i2c_command(0x00, 0x00);
	...
	case FL_MODE_TORCH:			//125mA
		...
		tps61310_i2c_command(0x01, 0x40);
	break;
	case FL_MODE_TORCH_LEVEL_1:	//25mA
		tps61310_i2c_command(0x05, 0x6A);
		...
		tps61310_i2c_command(0x01, 0x40);
	break;
	case FL_MODE_TORCH_LEVEL_2:	//75mA
		tps61310_i2c_command(0x05, 0x6A);
