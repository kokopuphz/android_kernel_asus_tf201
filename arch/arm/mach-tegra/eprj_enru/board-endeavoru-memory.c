...
static const struct tegra30_emc_table enterprise_emc_tables_h5tc2g_400[] = {
	{
		0x31,       /* Rev 3.1 */
...
static const struct tegra30_emc_table enterprise_emc_tables_h5tc2g_533[] = 
{
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
#if 0
static const struct tegra30_emc_table eternityproject_emc_tables_h5tc2g_667[] = {
	{
		0x32,       /* Rev 3.2 */
		51000,      /* SDRAM frequency */
		{
...
static struct tegra30_emc_pdata enru_hynix_h5tc2g = {
	.description	= "eprj_hynix_h5tc2g",
	.tables		= (struct tegra30_emc_table *)enterprise_emc_tables_h5tc2g_533,
	.num_tables	= ARRAY_SIZE(enterprise_emc_tables_h5tc2g_533)
};

int __init eprj_enru_init_emc(void)
{
	struct tegra30_emc_pdata *emc_platdata;

	emc_platdata = &enru_hynix_h5tc2g;
