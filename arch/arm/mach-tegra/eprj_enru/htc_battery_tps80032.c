...
//#define WK_ALARM_NOT_WORK 1 /* EPRJ: Causes permanent wakeup!!!! */
#define WK_ALARM_NOT_WORK 0
...
//		chip = gpio_to_chip(htc_batt_info.sw_temp_25);
//		WARN_ON(chip->can_sleep);
//		chip->set_pull(chip,
//			htc_batt_info.sw_temp_25 - chip->base,
//			__GPIO_PULL_NONE);
	}
