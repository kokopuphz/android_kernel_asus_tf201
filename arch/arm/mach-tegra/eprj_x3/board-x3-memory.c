 ...
 *
 * You should have received a copy of the GNU General sPublic License
...
static const struct tegra30_emc_table x3_emc_tables_k4p8g304eb[] = 
{
	...
	},
	{
		...
		400000,     /* SDRAM frequency */
		{
			...
			0x00008000, /* EMC_CFG_DIG_DLL_PERIOD */
			0x00040000, /* EMC_DLL_XFORM_DQS0 */
			0x00040000, /* EMC_DLL_XFORM_DQS1 */
			0x00040000, /* EMC_DLL_XFORM_DQS2 */
			0x00040000, /* EMC_DLL_XFORM_DQS3 */
			0x00040000, /* EMC_DLL_XFORM_DQS4 */
			0x00040000, /* EMC_DLL_XFORM_DQS5 */
			0x00040000, /* EMC_DLL_XFORM_DQS6 */
			0x00040000, /* EMC_DLL_XFORM_DQS7 */
			0x00000000, /* EMC_DLL_XFORM_QUSE0 */
			0x00000000, /* EMC_DLL_XFORM_QUSE1 */
			0x00000000, /* EMC_DLL_XFORM_QUSE2 */
			0x00000000, /* EMC_DLL_XFORM_QUSE3 */
...
#if defined(EMC_REV_3_2)
static struct tegra30_emc_pdata eprjx3_k4p8g304eb_v32 = {
	.description	= "eprj_x3memory",
	.tables		= (struct tegra30_emc_table*)x3_emc_tables_k4p8g304eb_v32,
	.num_tables	= ARRAY_SIZE(x3_emc_tables_k4p8g304eb_v32)
};
#else
static struct tegra30_emc_pdata eprjx3_k4p8g304eb = {
	.description	= "eprj_x3memory",
...
#if defined(EMC_REV_3_2)
	emc_platdata = &eprjx3_k4p8g304eb_v32;
#else
	emc_platdata = &eprjx3_k4p8g304eb;
#endif
