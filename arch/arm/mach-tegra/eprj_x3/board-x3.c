...
/************** EternityProject - Force board configuration check! **************/
#ifndef CONFIG_LGE_BATTERY
#warning "CONFIG_LGE_BATTERY not selected!!!"
#endif

#ifndef CONFIG_REBOOT_MONITOR
#warning "CONFIG_REBOOT_MONITOR not selected!!!"
#endif
/************** EternityProject - Force board configuration check! **************/
...
{
	pr_info("!!!!!EPRJ!!!!!! HARDWARE REVISION: 0x%x", system_rev);
	return system_rev;
}
